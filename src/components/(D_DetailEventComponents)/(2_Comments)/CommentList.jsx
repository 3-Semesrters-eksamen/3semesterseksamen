...
const inputBase = "w-full bg-transparent border border-white/15 rounded-sm text-white text-sm tracking-wider px-4 py-4 outline-none transition-colors duration-200 placeholder-white/30 focus:border-nightclub-pink";
          ...
          {editingId === comment.id ? (
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center justify-between">
                <button onClick={() => deleteComment(comment.id)} className="text-[0.75rem] tracking-[0.14em] text-gray-500 hover:text-nightclub-pink transition-colors duration-200 uppercase">
                  DELETE COMMENT
                </button>
                ...
                <div className="flex gap-6">
                  ...
                  <button onClick={() => saveEdit(comment.id)} disabled={isSaving} className="relative text-[0.82rem] font-bold tracking-[0.14em] text-white hover:text-nightclub-pink transition-colors duration-200 uppercase disabled:opacity-50 group">
                    {isSaving ? "SAVING..." : "SAVE"}
                    <span className="absolute bottom-0 left-0 right-0 h-px bg-white/40 transition-colors duration-200 group-hover:bg-nightclub-pink" />
                  </button>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex items-start justify-between gap-4">
                ...
                <button onClick={() => startEdit(comment)} className="text-[0.7rem] tracking-[0.14em] text-gray-500 hover:text-nightclub-pink transition-colors duration-200 uppercase shrink-0">
                  EDIT
                </button>
              </div>
