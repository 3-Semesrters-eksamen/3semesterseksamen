...
const WelcomeClubCard = ({ image, title, text }) => {
  return (
    <div className="group relative flex-1 h-[400px] overflow-hidden rounded-xl shadow-md cursor-pointer">
      ...
      {/* PinkFrame - Vi styrer dens synlighed herfra */}
      ...
      {/* Tekst Overlay */}
      <div className="absolute inset-0 z-20 bg-black/50 flex flex-col justify-center items-center text-center p-6 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
