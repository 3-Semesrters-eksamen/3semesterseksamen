  ...
  return (
    <div className="group relative w-full h-[320px] sm:h-[380px] lg:h-[460px] overflow-hidden shadow-md cursor-pointer">
      ...
      <div className="absolute inset-0 z-10 bg-black/90 flex flex-col justify-center items-center text-center p-6 gap-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
        {Icon && <Icon className="w-16 h-16 text-pink-500 text-5xl p-3 border-2 border-pink-500 rounded-lg bg-transparent" />}
        {iconImage && <img src={iconImage} alt="Icon" className="w-16 h-16 p-3 border-2 border-pink-500 rounded-lg bg-transparent object-contain" />}
        <h3
          className="text-white text-xl font-bold uppercase 
    scale-50 group-hover:scale-80 
